...
describe Gui do
  ...
  it 'allows a user to choose a 3 x 3 option' do
   expect(display.find_child(Qt::MenuBar, 'menu bar').actions[0].object_name).to eq("3 x 3 Option")
  end
  ...
  it 'changes status bar when winner found' do
    display.create_buttons
